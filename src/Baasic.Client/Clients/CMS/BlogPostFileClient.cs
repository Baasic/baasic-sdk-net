...
namespace Baasic.Client.Clients.CMS
{
    ...
    public class BlogPostFileClient : ClientBase, IBlogPostFileClient
    {
        ...
        /// <param name="blogPost">BlogPost number.</param>
        ...
        public virtual Task<CollectionModelBase<BlogPostFile>> FindAsync(string searchQuery = DefaultSearchQuery,
            int blogPost = DefaultPage, int rpp = DefaultMaxNumberOfResults,
            string sort = DefaultSorting, string embed = DefaultEmbed, string fields = DefaultFields)
        {
            return FindAsync(searchQuery, null, null, null, blogPost, rpp, sort, embed, fields);
        }
        ...
        public virtual Task<CollectionModelBase<BlogPostFile>> FindAsync(string searchQuery = DefaultSearchQuery,
            ...
            string sort = DefaultSorting, string embed = DefaultEmbed, string fields = DefaultFields)
        {
            return FindAsync<BlogPostFile>(searchQuery, from, to, ids, blogPost, rpp, sort, embed, fields);
        }
            ...
            where T : BlogPostFile
        {
            using (IBaasicClient client = BaasicClientFactory.Create(Configuration))
            {
                ...
                InitializeQueryString(uriBuilder, searchQuery, blogPost, rpp, sort, embed, fields);
