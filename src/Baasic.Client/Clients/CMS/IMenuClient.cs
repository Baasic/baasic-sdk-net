...
namespace Baasic.Client.Clients.CMS
{
    ...
    public interface IMenuClient
    {
        ...
        Task<CollectionModelBase<Menu>> FindAsync(string searchQuery = ClientBase.DefaultSearchQuery,
            ...
            string languageIds = null, int page = ClientBase.DefaultPage, int rpp = ClientBase.DefaultMaxNumberOfResults,
            string sort = ClientBase.DefaultSorting, string embed = ClientBase.DefaultEmbed, string fields = ClientBase.DefaultFields);
        ...
        Task<Menu> InsertAsync(Menu menu, bool? forcePositionsUpdate = null);
        ...
        Task<T> InsertAsync<T>(T menu, bool? forcePositionsUpdate = null) where T : Menu;
        ...
        Task<bool> UpdateAsync(Menu menu, bool? forcePositionsUpdate = null);
        ...
        Task<bool> UpdateAsync<T>(T menu, bool? forcePositionsUpdate = null) where T : Menu;
