...
namespace Baasic.Client.Clients.CMS
{
    ...
    /// </summary>
    internal class PageStatusClient : ClientBase, IPageStatusClient
    {
        #region Constructors
        ...
        public virtual Task<PageStatus> InsertAsync(PageStatus page)
        {
            return InsertAsync<PageStatus>(page);
        }
        ...
        public virtual Task<T> InsertAsync<T>(T page) where T : PageStatus
        {
            using (IBaasicClient client = BaasicClientFactory.Create(Configuration))
            {
        ...
        public virtual Task<PageStatus[]> InsertAsync(PageStatus[] pages)
        {
            return InsertAsync<PageStatus>(pages);
        }
        ...
        public virtual Task<T[]> InsertAsync<T>(T[] pages) where T : PageStatus
        {
            using (IBaasicClient client = BaasicClientFactory.Create(Configuration))
            {
        ...
        public virtual Task<bool> UpdateAsync(PageStatus page)
        {
            return UpdateAsync<PageStatus>(page);
        }
        ...
        public virtual async Task<bool> UpdateAsync<T>(T page) where T : PageStatus
        {
            try
            {
                using (IBaasicClient client = BaasicClientFactory.Create(Configuration))
                {
                    var result = await client.PutAsync<PageStatus, HttpStatusCode>(client.GetApiUrl(String.Format("{0}/{1}", ModuleRelativePath, page.Id)), page);
                    switch (result)
                    {
        ...
        public virtual Task<PageStatus[]> UpdateAsync(PageStatus[] pages)
        {
            return UpdateAsync<PageStatus>(pages);
        }
        ...
        public virtual Task<T[]> UpdateAsync<T>(T[] pages) where T : PageStatus
        {
            using (IBaasicClient client = BaasicClientFactory.Create(Configuration))
            {
